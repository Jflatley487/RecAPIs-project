...
fetch(
  `https://api.spoonacular.com/recipes/findByIngredients?apiKey=${APIkey}&ingredients=${protein}`
)
...
//need to add <button id="favorite-button">Add to Favorites</button> to html
//need to test
